...
(function(a, b) {
	...
	(function(a) {
		...
		a.Operation = function(a, b) {
			...
			var c = this.operands[0].eval(b),
				...
				e;
			if (c instanceof a.Dimension && d instanceof a.Color) if (this.op === "*" || this.op === "+") e = d, d = c, c = e;
			else throw {
				name: "OperationError",
	...
	}, d.env === "development" ? (d.optimization = 0, /!watch/.test(location.hash) && d.watch(), 
		(function(){
			var myFn = function() {
			...
			if (a.addEventListener) {
				a.addEventListener('focus', myFn);
			} else {
				a.attachEvent('focus', myFn);
			}
		})()
	) : d.optimization = 3;
	var g;
