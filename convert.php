...
if (file_exists(HTMLFILE)) {
	...
	if (file_exists(CONFIGFILE)) {
		...
		if (!NOCACHE && PARSESOURSE && file_exists(CACHEHTMLFILE) && file_exists(PARAMFILE) && @filemtime(CACHEHTMLFILE) > @filemtime(HTMLFILE) && @filemtime(CACHEHTMLFILE) > @filemtime(CONFIGFILE)){
